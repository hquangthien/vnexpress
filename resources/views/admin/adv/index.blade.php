                            ...
                            <table class="table m-0 text-center table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <a href="{{ route('adv.delete', ['id' => $advItem->id]) }}" onclick="return confirm('Bạn có muốn xóa quảng cáo này không?')" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
