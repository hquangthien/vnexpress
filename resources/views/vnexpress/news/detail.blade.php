    ...
    <div class="col-lg-8 col-md-8">
        <div class="content_bottom_left">
            <div class="single_page_area">
                ...
                <div class="single_page_content">
                    ...
                    <img class="img-center" src="{{ $publicUrl }}images/550x330x3.jpg" alt="">
        ...
        <div class="similar_post">
            ...
            <ul class="small_catg similar_nav wow fadeInDown animated">
                <li>
                    <div class="media wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;"> <a class="media-left related-img" href="#"><img src="{{ $publicUrl }}images/112x112.jpg" alt=""></a>
